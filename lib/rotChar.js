...
RotChar.prototype.choosePersonality = function () {
  ...
  choice = Math.random();
  if (choice < .25)      this.personality = Asteroids.AI.Sessile.update;
  else if (choice < .625) this.personality = Asteroids.AI.Orbiter.update;
  else                   this.personality = Asteroids.AI.Sentinal.update;
};
