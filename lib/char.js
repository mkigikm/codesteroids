...
Char.prototype.changeDirection = function () {
  if (!this.coordinator()) return;
  //
  // if (this.traveled - this.lastChange > 50) {
  //   this.head.set(Asteroids.Vector.random());
  //   this.lastChange = this.traveled;
  // }
  this.head.rot(Math.PI/200)
};
