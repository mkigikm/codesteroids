(function () {
  ...
  Vector.collide = function (pos0, pos1, vec0, vec1) {
    var before = vec0.addC(vec1);
    var n = pos1.addC(pos0, -1), vn0, vn1, vt0, vt1;
    console.log("positions", pos0.toString(), pos1.toString())
    console.log("n", n.toString());
    n.norm();
    console.log("n", n.toString(), n.mag());
    ...
    console.log("vec1",vn1.addC(vt1, -1).toString(), vec1.toString())
    console.log("vec0",vn0.addC(vt0, -1).toString(), vec0.toString())

    vec1.set(vt1.add(vn0));
    vec0.set(vt0.add(vn1));
    var after = vec0.addC(vec1);
    console.log("before",before.toString(), "after",after.toString());
    console.log(before.mag(), after.mag())
  };
})();
