(function () {
  ...
  Asteroids.Util.midPoint = function (pos0, pos1) {
    // console.log(pos0, pos1)
    var mid = Asteroids.Util.vecAdd(pos0.slice(), pos1);
    // console.log(mid)
    return Asteroids.Util.vecMult(0.5, mid);
  };

  Asteroids.Util.dotProd = function (vec0, vec1) {
    return vec0[0] * vec1[0] + vec0[1] * vec1[1];
  };

  Asteroids.Util.parallel = function (pos0, pos1, mid) {
    var d0 = Asteroids.Util.distance(pos0, mid),
        d1 = Asteroids.Util.distance(pos1, mid);
    console.log(pos0, pos1, mid)
    console.log(d0, d1)

    return Math.abs(d0 - d1) < 0.01;
  }
})();
