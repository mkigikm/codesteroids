...
GameView.prototype.centerX = function (x) {
  if (this.width > Asteroids.Game.DIM_X) {
    return (this.width - Asteroids.Game.DIM_X) / 2;
  }
...
GameView.prototype.centerY = function (y) {
  if (this.height - 50 > Asteroids.Game.DIM_Y) {
    return (this.height - 50 - Asteroids.Game.DIM_Y) / 2;
  }
...
GameView.prototype.drawHud = function (ship) {
  ...
  this.ctx.translate((this.width - 760) / 2, 0);
