...
Ship.prototype.moveShip = function () {
  ...
  if (Asteroids.Game.outOfBounds(this.pos)) {
    ...
    if (this.pos.x > Asteroids.Game.DIM_X) this.pos.x = Asteroids.Game.DIM_X;
    if (this.pos.y < 0) this.pos.y = 0;
    if (this.pos.y > Asteroids.Game.DIM_Y) this.pos.y = Asteroids.Game.DIM_Y;
    this.guidance.head.rot(Math.PI / 2);
    this.guidance.speed /= 2;
  }
  // if (Asteroids.Game.outOfBounds(this.pos) && !this.victory) {
